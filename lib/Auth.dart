...
Future<String> createAccount(String firstName, String lastName, String _email, String _password) async{
  try{
    User? user =(await FirebaseAuth.instance.createUserWithEmailAndPassword(email: _email, password: _password)).user;

    await signUpUser(uid: user!.uid).signUpData(firstName, lastName, _email, _password);
    return "null";
...
class signUpUser{
  ...
  Future signUpData(String firstName, String lastName, String email, String password) async{
